        ...
        for y in range(Image.size[1]):
            if x==0 and y<4:
                ...
                if pixelPosition<len(byteArrays)*2+8:
                    ...
                    newPixel =( changeRGBA(currentPixel[0], byteArrays[arrayPosition][pixelPosition%2*4+0]),
                                changeRGBA(currentPixel[1], byteArrays[arrayPosition][pixelPosition%2*4+1]),
                                changeRGBA(currentPixel[2], byteArrays[arrayPosition][pixelPosition%2*4+2]),
                                changeRGBA(currentPixel[3], byteArrays[arrayPosition][pixelPosition%2*4+3]))    
                    pixelPosition+=1            
